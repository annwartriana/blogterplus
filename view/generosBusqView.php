                    ...
                    <div-container>
                        <div class="row">
                            <div class="">
                                ...
                                <hr><h2 class="text-center my-4"> <?php  echo ucfirst($generoGet) ?></h2><hr>
                                <div class="d-flex flex-wrap justify-content-center justify-content-lg-around mt-4">
                                    ...
                                    $datosObras = $consultaObra->consultarGenero($generoGet);
                                    ...
                                    if(count($datosObras)>0){
                                        ...
                                        <div class="row g-0">
                                                    <div class="col-md-4 d-flex align-items-center">
                                                        <img style="max-height: 200px; max-width=200px;" src="/view/assets/img/sorry.jpg" class="img-fluid rounded-start" alt="...">
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="card-body">
                                                            <h5 class="card-title">Lo sentimos, aún no hay historias de ese género. </h5>
                                                            <p class="card-text fst-italic">Sé el primero en escribir una! </p>                                                            
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div></a>
