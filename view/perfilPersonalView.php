            ...
            <div class="row">
                ...
                <section class="col-12 col-md-3 mx-1">
                                        ...
                                        <div class="modal-body">
                                            <ul class="list-group" style="overflow-y:scroll;">
                                                ...
                                                if (count($arrayIdSeguidores) > 0) {
                                                    ...
                                                    echo '<div><li class="list-group-item">Aún no tienes seguidores.</li> </div>';
                                                }
                                        ...
                                        <div class="modal-body">
                                            <ul class="list-group" style="overflow-y:scroll;">
                                                ...
                                                if (count($arrayIdSeguidores) > 0) {
                                                    ...
                                                    echo '<div><li class="list-group-item">Aún no sigues a nadie.</li> </div>';
                                                }
                    ...
                    <div class="d-flex justify-content-center mt-5">
                        <a class="btn-editObra" href="/view/editPerfil.php"> Editar Perfil</a>
                    </div>
                ...
                <section class="col-12 col-md-7">
                    ...
                    <div class="col-12">
                            ...
                            if (count($datosObras) > 0) {
                                ...
                                foreach ($datosObras as $elemento) {
                                    ...
                                    if ($contadorElementos < 4) {
                                        ...
                                        echo ' 
                                        <div class="card">      
                                            <img src="/view/assets/portadas/' . $portada . '" class="card-img-top" alt="...">
                                            <div class="card-body">
                        ...
                        if (count($consultUltCaps) > 0) {
                            ...
                            echo '<h2 class="mt-5 text-center"> Tus últimos Capítulos</h2> 
                               <div class="my-3">';
